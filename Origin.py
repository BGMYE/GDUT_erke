...
if __name__ == "__main__":
    ...
    for i in range(N):
        ...
        Sign_in = f"http://erke.gdut.edu.cn/public/index.php/mobile/activity-sign-result?id={id_str}&type=in&token={In_time}"
        Sign_out = f"http://erke.gdut.edu.cn/public/index.php/mobile/activity-sign-result?id={id_str}&type=out&token={Out_time}"
